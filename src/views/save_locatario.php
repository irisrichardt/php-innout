<main class="content">
  <?php
  renderTitle(
    $id ? 'Editar Locatário' : 'Cadastrar Locatário',
    $id ? 'Altere as informações do locatário' : 'Preencha o formulário para cadastrar um novo locatário',
    'icofont-users-alt-4'
  );
  ...
  <form action="#" method="post">
    ...
    <div class="d-flex justify-content-between mt-5">
      ...
      <a href="/locatarios.php" class="btn btn-secondary">
        Cancelar
      </a>
    </div>
  </form>
